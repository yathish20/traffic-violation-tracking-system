...
<div class="full">
  ...
  <div class="main">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-custom fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"><h2><i class="fa-solid fa-traffic-light"></i> Admin Panel</h2></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a id="name"><i class="fa-regular fa-user"></i>  <span style="font-size: 20px;">Admin</span></a>
            </li> 
          </ul>
        </div>
      </div>
